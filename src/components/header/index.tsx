      ...
      <nav className="mx-auto max-w-[500px] bg-[var(--color-surface)] rounded-xl overflow-hidden border border-white/5">
        <div className="h-14 px-4 lg:px-6 flex items-center justify-between">
          ...
          <a href={FULLSTACK_TRADE_URL} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 shrink-0">
            ...
            <span className="hidden md:inline text-[var(--text-primary)] font-medium tracking-wider text-sm uppercase">
              Fullstack
            </span>
          </a>

          {/* Order Book badge */}
          <span className="inline-flex items-center gap-2 h-8 px-4 rounded-full bg-[var(--color-ask)]/10 border border-[var(--color-ask)]/30 font-mono uppercase tracking-[0.08em] text-xs text-[var(--color-ask)]">
